...
export class PostingAccountApiService {
  ...
  getAllByPage(pageFilter: PageFilterModel): Observable<PageModel<PostingAccountsGetResource>> {
    ...
    if (pageFilter.advancedSearchFormValue != null) {
      if (pageFilter.advancedSearchFormValue.accountClass != null) {
        params = params.set('accountClass', pageFilter.advancedSearchFormValue.accountClass);
      }
